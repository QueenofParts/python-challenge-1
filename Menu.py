...
# 1. Set up order list. Order list will store a list of dictionaries for the menu.
# Order List
order_list = []

# Launch the store and present a greeting to the customer
print("    Welcome to the Marnie's Diner food truck!\n")
...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection = input("Please type the item number of your choice:  ")
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    item_quantity = input("Please enter the number you'd like: ")
    ...
    # Ask the customer if they would like to order anything else
        ...
        # The customer didn't type a valid input
        ...
        # 7. Store the dictionary items as variables
            line_print_dict = order_list[i]
            item_name = line_print_dict["Item name"]
            price = line_print_dict["Price"]

        # 8. Calculate the number of spaces for formatted printing
        num_item_spaces = 24 - len(item_name)

        # 9. nCreate space strings
        item_spaces = " " * num_item_spaces
