...
while place_order:
        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                # Tell the customer that their input isn't valid
                    ...
                    print("That was not a valid menu item number. Please try again.")
    ...
    # 7. Store the dictionary items as variables
        ...
        price = order[i]["Price"]
        item_quantity = order[i]["Item quantity"]
        ...
        total_price = sum([item["Price"] * item["Item quantity"] for item in order])
